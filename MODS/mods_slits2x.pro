...
;
; CALLING SEQUENCE:
;   ximg = mods_slits2x( tset_slits, [ slitid=, xshift=, nslit= ] )
;
; INPUTS:
...
;-  
;------------------------------------------------------------------------------
function mods_slits2x, tset_slits1, pixleft = pixleft, pixright = pixright $
...
;           xx2[*,slitid-1] = xx1[*,slitid-1] + meds
   ...
   slitmask = mods_slits2mask(tset_slits)
